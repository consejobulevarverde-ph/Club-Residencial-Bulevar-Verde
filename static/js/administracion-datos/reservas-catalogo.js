(function () {
  ...
  var $ = AdminDatos.$;
  var apiFetch = AdminDatos.apiFetch;
  var msg = AdminDatos.msg;
  var hideMsg = AdminDatos.hideMsg;
  var withIdToken = AdminDatos.withIdToken;
  var esc = AdminDatos.esc;
  var busy = AdminDatos.busy;
  var state = AdminDatos.state;
  var mode = AdminDatos.mode;
  
  // All module functions below
      function esc(value) {
  ...
  AdminDatos.registrarModulo({ id: 'reservas-catalogo', buttonId: 'showReservasCatalogo', viewId: 'reservasCatalogoView', onFirstShow: cargarReservasCatalogo });
}());
