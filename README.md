...
| `DEPLOY_INSTRUCTIONS.md` | Guía completa de despliegue (Firebase + Cloud Run + API) |
...
- [DEPLOY_INSTRUCTIONS.md](DEPLOY_INSTRUCTIONS.md) - Guía de despliegue completa
- [CLAUDE.md](CLAUDE.md) - Contexto técnico y arquitectura
